...
export type BrmPrimaryCategory = "보건" | "일반행정" | "문화/관광" | "산업/경제" | "복지" | "환경" | "교통" | "도시관리" | "교육" | "안전" | "인구/가구" | "주택/건설";
export interface BrmClassification {
    primary: BrmPrimaryCategory | null;
    secondary?: string | null;
    code?: string | null;
    source: "catalog_map_category" | "official_brm_code" | "official_mapping" | "keyword_inference" | "unclassified";
    confidence: "high" | "medium" | "low";
}
export type OrganizationType = "headquarters" | "district" | "business_office" | "invested_funded" | "other";
export interface OrganizationClassification {
    type: OrganizationType;
    label: string;
    organizationName: string;
    source: "official_registry" | "raw_division" | "official_mapping" | "verified_name_rule" | "unclassified";
    confidence: "high" | "medium" | "low";
}
