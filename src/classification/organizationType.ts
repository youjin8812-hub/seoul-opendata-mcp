...
import type { OrganizationClassification, OrganizationType, RawSeoulCatalogItem } from "../types/index.js";

const DIVISION_MAP: Record<string, { type: OrganizationType; label: string }> = {
...
export function classifyOrganization(raw: RawSeoulCatalogItem): OrganizationClassification {
